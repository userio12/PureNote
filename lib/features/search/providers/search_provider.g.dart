...
String _$searchResultsHash() => r'1f19845b75e252cea9e5c3f020a16618d565ee28';
...
/// See also [searchResults].
class SearchResultsFamily extends Family<AsyncValue<List<Note>>> {
  /// See also [searchResults].
...
/// See also [searchResults].
class SearchResultsProvider extends AutoDisposeStreamProvider<List<Note>> {
  /// See also [searchResults].
  ...
  Override overrideWith(
    Stream<List<Note>> Function(SearchResultsRef provider) create,
  ) {
...
mixin SearchResultsRef on AutoDisposeStreamProviderRef<List<Note>> {
...
String _$recentSearchesHash() => r'4e36a5584331e2d73b16e0f6529ff276e5181ba0';

/// See also [RecentSearches].
@ProviderFor(RecentSearches)
final recentSearchesProvider =
    AsyncNotifierProvider<RecentSearches, List<String>>.internal(
      RecentSearches.new,
...
typedef _$RecentSearches = AsyncNotifier<List<String>>;
